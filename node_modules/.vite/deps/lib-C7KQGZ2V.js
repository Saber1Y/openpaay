import {
  ...
  toUtf8Bytes,
  toUtf8String
} from "./chunk-SFL6HTCO.js";
import {
  accessListify,
  parse,
  require_hash
} from "./chunk-MKPXTPGQ.js";
import {
  AddressZero,
  BigNumber,
  Description,
  ...
  resolveProperties,
  shallowCopy
} from "./chunk-FMIIRTQS.js";
import "./chunk-WON7JB3Q.js";
import "./chunk-VQOLUPG3.js";
import "./chunk-EDISPEFM.js";
import {
  Logger,
  arrayify,
  concat,
...
var version = "abstract-provider/5.8.0";
...
var Formatter = class _Formatter {
  ...
  hex(value, strict) {
    ...
    return logger5.throwArgumentError("invalid hash", "value", value);
  }
  data(value, strict) {
      ...
      if (result.root.length <= 4) {
        ...
        if (value2 === 0 || value2 === 1) {
          if (result.status != null && result.status !== value2) {
            logger5.throwArgumentError("alt-root-status/status mismatch", "value", { root: result.root, status: result.status });
          }
          result.status = value2;
          delete result.root;
        } else {
          logger5.throwArgumentError("invalid alt-root-status", "value.root", result.root);
        }
      } else if (result.root.length !== 66) {
        logger5.throwArgumentError("invalid root hash", "value.root", result.root);
      }
    }
...
function checkTopic(topic) {
  ...
  if (hexDataLength(topic) !== 32) {
    logger6.throwArgumentError("invalid topic", "topic", topic);
  }
...
function getIpfsLink(link) {
  if (link.match(/^ipfs:\/\/ipfs\//i)) {
    ...
    logger6.throwArgumentError("unsupported IPFS format", "link", link);
  }
...
var Resolver = class {
    ...
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (arrayify(result).length % 32 === 4) {
          logger6.throwError("resolver threw error", Logger.errors.CALL_EXCEPTION, {
            transaction: tx,
            data: result
          });
        }
  ...
  _getAddress(coinType, hexBytes) {
    ...
    if (coinInfo == null) {
      logger6.throwError(`unsupported coin type: ${coinType}`, Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    if (coinInfo.prefix != null) {
      ...
      if (version8 >= 0 && bytes.length === 2 + length && length >= 1 && length <= 75) {
  ...
  getAddress(coinType) {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (address == null) {
        logger6.throwError(`invalid or unsupported coin data`, Logger.errors.UNSUPPORTED_OPERATION, {
          operation: `getAddress(${coinType})`,
          coinType,
          data: hexBytes
        });
  ...
  getContentHash() {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      return logger6.throwError(`invalid or unsupported content hash data`, Logger.errors.UNSUPPORTED_OPERATION, {
...
var BaseProvider = class extends Provider {
  ...
  constructor(network) {
    ...
    if (network instanceof Promise) {
      ...
      if (knownNetwork) {
        ...
        logger6.throwArgumentError("invalid network", "network", network);
      }
    }
    ...
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      for (let i = 0; i < urls.length; i++) {
        ...
        if (result.status >= 400 && result.status < 500) {
          return logger6.throwError(`response not found during CCIP fetch: ${errorMessage}`, Logger.errors.SERVER_ERROR, { url, errorMessage });
        }
        errorMessages.push(errorMessage);
      }
      return logger6.throwError(`error encountered during CCIP fetch: ${errorMessages.map((m) => JSON.stringify(m)).join(", ")}`, Logger.errors.SERVER_ERROR, {
        urls,
        errorMessages
      });
    });
  ...
  poll() {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (Math.abs(this._emitted.block - blockNumber) > 1e3) {
        logger6.warn(`network block skew detected; skipping block events (emitted=${this._emitted.block} blockNumber${blockNumber})`);
        this.emit("error", logger6.makeError("network block skew detected", Logger.errors.NETWORK_ERROR, {
          blockNumber,
          event: "blockSkew",
  ...
  detectNetwork() {
    return __awaiter4(this, void 0, void 0, function* () {
      return logger6.throwError("provider does not support network detection", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  getNetwork() {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (network.chainId !== currentNetwork.chainId) {
        ...
        const error = logger6.makeError("underlying network changed", Logger.errors.NETWORK_ERROR, {
          event: "changed",
          network,
    ...
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      return new Promise((resolve, reject) => {
        ...
        if (replaceable) {
          ...
          const replaceHandler = (blockNumber) => __awaiter4(this, void 0, void 0, function* () {
            if (done) {
              return;
            }
            yield stall(1e3);
            this.getTransactionCount(replaceable.from).then((nonce) => __awaiter4(this, void 0, void 0, function* () {
              if (done) {
                return;
              }
                ...
                while (scannedBlock <= blockNumber) {
                  ...
                  for (let ti = 0; ti < block.transactions.length; ti++) {
                    ...
                    if (tx.from === replaceable.from && tx.nonce === replaceable.nonce) {
                      ...
                      reject(logger6.makeError("transaction was replaced", Logger.errors.TRANSACTION_REPLACED, {
        ...
        if (typeof timeout === "number" && timeout > 0) {
          const timer2 = setTimeout(() => {
            ...
            reject(logger6.makeError("timeout exceeded", Logger.errors.TIMEOUT, { timeout }));
          }, timeout);
          if (timer2.unref) {
            timer2.unref();
          }
  ...
  getGasPrice() {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      try {
        ...
        return logger6.throwError("bad result from backend", Logger.errors.SERVER_ERROR, {
          method: "getGasPrice",
          result,
          error
        });
  ...
  _wrapTransaction(tx, hash2, startBlock) {
    ...
    if (hash2 != null && tx.hash !== hash2) {
      logger6.throwError("Transaction hash mismatch from Provider.sendTransaction.", Logger.errors.UNKNOWN_ERROR, { expectedHash: tx.hash, returnedHash: hash2 });
    }
    result.wait = (confirms, timeout) => __awaiter4(this, void 0, void 0, function* () {
      if (confirms == null) {
        confirms = 1;
      }
      if (timeout == null) {
      ...
      if (receipt.status === 0) {
        logger6.throwError("transaction failed", Logger.errors.CALL_EXCEPTION, {
  ...
  _call(transaction, blockTag, attempt) {
    return __awaiter4(this, void 0, void 0, function* () {
      if (attempt >= MAX_CCIP_REDIRECTS) {
        logger6.throwError("CCIP read exceeded maximum redirections", Logger.errors.SERVER_ERROR, {
          redirects: attempt,
          transaction
        });
      }
      ...
      if (attempt >= 0 && blockTag === "latest" && txSender != null && result.substring(0, 10) === "0x556f1830" && hexDataLength(result) % 32 === 4) {
        try {
          ...
          if (!BigNumber.from(sender).eq(txSender)) {
            logger6.throwError("CCIP Read sender did not match", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
          ...
          for (let u = 0; u < urlsLength; u++) {
            ...
            if (url == null) {
              logger6.throwError("CCIP Read contained corrupt URL string", Logger.errors.CALL_EXCEPTION, {
                name: "OffchainLookup",
                signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
                transaction,
                data: result
          ...
          if (!BigNumber.from(hexDataSlice(data, 100, 128)).isZero()) {
            logger6.throwError("CCIP Read callback selector included junk", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
              signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
              transaction,
              data: result
          ...
          if (ccipResult == null) {
            logger6.throwError("CCIP Read disabled or provided no URLs", Logger.errors.CALL_EXCEPTION, {
              name: "OffchainLookup",
              signature: "OffchainLookup(address,string[],bytes,bytes4,bytes)",
              transaction,
              data: result
  ...
  _getAddress(addressOrName) {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (typeof addressOrName !== "string") {
        logger6.throwArgumentError("invalid address or ENS name", "name", addressOrName);
      }
      const address = yield this.resolveName(addressOrName);
      if (address == null) {
        logger6.throwError("ENS name not configured", Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (isHexString(blockHashOrBlockTag, 32)) {
        ...
        try {
          ...
          logger6.throwArgumentError("invalid block hash or block tag", "blockHashOrBlockTag", blockHashOrBlockTag);
        }
      }
      return poll(() => __awaiter4(this, void 0, void 0, function* () {
  ...
  _getBlockTag(blockTag) {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (typeof blockTag === "number" && blockTag < 0) {
        if (blockTag % 1) {
          logger6.throwArgumentError("invalid BlockTag", "blockTag", blockTag);
        }
  ...
  _getResolver(name, operation) {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (!network.ensAddress) {
        logger6.throwError("network does not support ENS", Logger.errors.UNSUPPORTED_OPERATION, { operation, network: network.name });
      }
      try {
  ...
  resolveName(name) {
    return __awaiter4(this, void 0, void 0, function* () {
      ...
      if (typeof name !== "string") {
        logger6.throwArgumentError("invalid ENS name", "name", name);
      }
  ...
  perform(method, params) {
    return logger6.throwError(method + " not implemented", Logger.errors.NOT_IMPLEMENTED, { operation: method });
  }
  _startEvent(event) {
...
var Signer = class _Signer {
  ...
  constructor() {
    logger7.checkAbstract(new.target, _Signer);
...
function checkError(method, error, params) {
  ...
  if (method === "call") {
    ...
    logger8.throwError("missing revert data in call exception; Transaction reverted without a reason string", Logger.errors.CALL_EXCEPTION, {
      data: "0x",
      transaction,
      error
    });
  ...
  if (message.match(/only replay-protected/i)) {
    logger8.throwError("legacy pre-eip-155 transactions not supported", Logger.errors.UNSUPPORTED_OPERATION, {
      error,
      method,
      transaction
    });
...
var JsonRpcSigner = class extends Signer {
  constructor(constructorGuard, provider, addressOrIndex) {
    ...
    if (typeof addressOrIndex === "string") {
      ...
      logger8.throwArgumentError("invalid address or index", "addressOrIndex", addressOrIndex);
    }
  }
  connect(provider) {
    return logger8.throwError("cannot alter JSON-RPC Signer connection", Logger.errors.UNSUPPORTED_OPERATION, {
      operation: "connect"
    });
  }
  connectUnchecked() {
  ...
  getAddress() {
    ...
    return this.provider.send("eth_accounts", []).then((accounts) => {
      if (accounts.length <= this._index) {
        logger8.throwError("unknown account #" + this._index, Logger.errors.UNSUPPORTED_OPERATION, {
    ...
    return resolveProperties({
      ...
      return this.provider.send("eth_sendTransaction", [hexTx]).then((hash2) => {
        ...
        if (typeof error.message === "string" && error.message.match(/user denied/i)) {
          logger8.throwError("user rejected transaction", Logger.errors.ACTION_REJECTED, {
  ...
  signTransaction(transaction) {
    return logger8.throwError("signing transactions is unsupported", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  signMessage(message) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (typeof error.message === "string" && error.message.match(/user denied/i)) {
          logger8.throwError("user rejected signing", Logger.errors.ACTION_REJECTED, {
            action: "signMessage",
            from: address,
            messageData: message
          });
...
var JsonRpcProvider = class extends BaseProvider {
    ...
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (chainId != null) {
        ...
        try {
          ...
          return logger8.throwError("could not detect network", Logger.errors.NETWORK_ERROR, {
            chainId,
  ...
  perform(method, params) {
    return __awaiter6(this, void 0, void 0, function* () {
      ...
      if (args == null) {
        logger8.throwError(method + " not implemented", Logger.errors.NOT_IMPLEMENTED, { operation: method });
      }
      try {
...
var WebSocketProvider = class extends JsonRpcProvider {
  constructor(url, network) {
    if (network === "any") {
      logger9.throwError("WebSocketProvider does not support 'any' network yet", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  resetEventsBlock(blockNumber) {
    logger9.throwError("cannot reset events block on WebSocketProvider", Logger.errors.UNSUPPORTED_OPERATION, {
      operation: "resetEventBlock"
    });
  }
  set pollingInterval(value) {
    logger9.throwError("cannot set polling interval on WebSocketProvider", Logger.errors.UNSUPPORTED_OPERATION, {
  ...
  set polling(value) {
    ...
    logger9.throwError("cannot set polling on WebSocketProvider", Logger.errors.UNSUPPORTED_OPERATION, {
...
var logger12 = new Logger(version5);
...
function getHost(name) {
  ...
  return logger12.throwArgumentError("unsupported network", "name", name);
}
...
var logger13 = new Logger(version5);
var CloudflareProvider = class extends UrlJsonRpcProvider {
  static getApiKey(apiKey) {
    if (apiKey != null) {
      logger13.throwArgumentError("apiKey not supported for cloudflare", "apiKey", apiKey);
    }
    return null;
  }
  static getUrl(network, apiKey) {
...
function checkError2(method, error, transaction) {
  if (method === "call" && error.code === Logger.errors.SERVER_ERROR) {
    ...
    if (e && (e.message.match(/reverted/i) || e.message.match(/VM execution error/i))) {
      ...
      logger14.throwError("missing revert data in call exception", Logger.errors.CALL_EXCEPTION, {
        error,
        data: "0x"
      });
    }
  ...
  if (message.match(/insufficient funds/)) {
    logger14.throwError("insufficient funds for intrinsic transaction cost", Logger.errors.INSUFFICIENT_FUNDS, {
      error,
      method,
      transaction
    });
  ...
  if (message.match(/same hash was already imported|transaction nonce is too low|nonce too low/)) {
    logger14.throwError("nonce has already been used", Logger.errors.NONCE_EXPIRED, {
      error,
      method,
      transaction
    });
  ...
  if (message.match(/another transaction with same nonce/)) {
    logger14.throwError("replacement fee too low", Logger.errors.REPLACEMENT_UNDERPRICED, {
      error,
      method,
      transaction
    });
  ...
  if (message.match(/execution failed due to an exception|execution reverted/)) {
    logger14.throwError("cannot estimate gas; transaction may fail or may require manual gas limit", Logger.errors.UNPREDICTABLE_GAS_LIMIT, {
      error,
      method,
      transaction
    });
...
var EtherscanProvider = class extends BaseProvider {
  ...
  getBaseUrl() {
    ...
    return logger14.throwArgumentError("unsupported network", "network", this.network.name);
  }
        ...
        case "getLogs": {
          ...
          if (params.filter.topics && params.filter.topics.length > 0) {
            if (params.filter.topics.length > 1) {
              logger14.throwError("unsupported topic count", Logger.errors.UNSUPPORTED_OPERATION, { topics: params.filter.topics });
            }
            if (params.filter.topics.length === 1) {
              const topic0 = params.filter.topics[0];
              if (typeof topic0 !== "string" || topic0.length !== 66) {
                logger14.throwError("unsupported topic format", Logger.errors.UNSUPPORTED_OPERATION, { topic0 });
              }
              args.topic0 = topic0;
            }
          }
...
var logger16 = new Logger(version5);
function now() {
  return (/* @__PURE__ */ new Date()).getTime();
}
  ...
  for (let i = 0; i < networks2.length; i++) {
    ...
    if (result) {
      if (!(result.name === network.name && result.chainId === network.chainId && (result.ensAddress === network.ensAddress || result.ensAddress == null && network.ensAddress == null))) {
        logger16.throwArgumentError("provider mismatch", "networks", networks2);
      }
    } else {
      result = network;
    }
...
function getRunner(config, currentBlockNumber, method, params) {
  return __awaiter11(this, void 0, void 0, function* () {
    ...
    return logger16.throwError("unknown method error", Logger.errors.UNKNOWN_ERROR, {
      method,
      params
    });
  });
...
var FallbackProvider = class extends BaseProvider {
  constructor(providers, quorum) {
    if (providers.length === 0) {
      logger16.throwArgumentError("missing providers", "providers", providers);
    }
    const providerConfigs = providers.map((configOrProvider, index) => {
      ...
      if (weight % 1 || weight > 512 || weight < 1) {
        logger16.throwArgumentError("invalid weight; must be integer in [1, 512]", `providers[${index}].weight`, weight);
      }
    ...
    if (quorum == null) {
      ...
      logger16.throwArgumentError("quorum will always fail; larger than total weight", "quorum", quorum);
    }
    ...
    return __awaiter11(this, void 0, void 0, function* () {
      ...
      while (true) {
        ...
        Object.keys(errors).forEach((errorCode) => {
          ...
          logger16.throwError(e.reason || e.message, errorCode, props);
        });
      ...
      return logger16.throwError("failed to meet quorum", Logger.errors.SERVER_ERROR, {
        method,
        params,
...
var logger17 = new Logger(version5);
...
var InfuraWebSocketProvider = class extends WebSocketProvider {
  constructor(network, apiKey) {
    ...
    if (connection.password) {
      logger17.throwError("INFURA WebSocket project secrets unsupported", Logger.errors.UNSUPPORTED_OPERATION, {
...
var InfuraProvider = class extends UrlJsonRpcProvider {
  ...
  static getApiKey(apiKey) {
    ...
    if (typeof apiKey === "string") {
      ...
      logger17.assertArgument(typeof apiKey.projectId === "string", "projectSecret requires a projectId", "projectId", apiKey.projectId);
      logger17.assertArgument(typeof apiKey.projectSecret === "string", "invalid projectSecret", "projectSecret", "[REDACTED]");
  ...
  static getUrl(network, apiKey) {
    ...
    switch (network ? network.name : "unknown") {
      ...
      case "arbitrum-sepolia":
        ...
        break;
      default:
        logger17.throwError("unsupported network", Logger.errors.INVALID_ARGUMENT, {
          argument: "network",
          value: network
        });
    }
...
var logger18 = new Logger(version5);
...
var NodesmithProvider = class extends UrlJsonRpcProvider {
  ...
  static getUrl(network, apiKey) {
    logger18.warn("NodeSmith will be discontinued on 2019-12-20; please migrate to another platform.");
    let host = null;
    switch (network.name) {
      case "homestead":
...
var logger19 = new Logger(version5);
...
var PocketProvider = class extends UrlJsonRpcProvider {
  static getApiKey(apiKey) {
    ...
    if (apiKey == null) {
      ...
      logger19.throwArgumentError("unsupported PocketProvider apiKey", "apiKey", apiKey);
    }
    return apiKeyObj;
  }
  static getUrl(network, apiKey) {
...
var logger20 = new Logger(version5);
...
var logger21 = new Logger(version5);
var _nextId = 1;
...
var logger22 = new Logger(version5);
...
//# sourceMappingURL=lib-C7KQGZ2V.js.map
