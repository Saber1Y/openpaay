...
var version2 = "transactions/5.8.0";
...
function _serialize(transaction, signature2) {
  ...
  if (chainId !== 0) {
    ...
    v += chainId * 2 + 8;
    if (sig.v > 28 && sig.v !== v) {
      logger2.throwArgumentError("transaction.chainId/signature.v mismatch", "signature", signature2);
    }
  } else if (sig.v !== v) {
    logger2.throwArgumentError("transaction.chainId/signature.v mismatch", "signature", signature2);
  }
...
function serialize(transaction, signature2) {
  ...
  return logger2.throwError(`unsupported transaction type: ${transaction.type}`, Logger.errors.UNSUPPORTED_OPERATION, {
...
function _parseEip1559(payload) {
  ...
  if (transaction.length !== 9 && transaction.length !== 12) {
    logger2.throwArgumentError("invalid component count for transaction type: 2", "payload", hexlify(payload));
  }
...
function _parseEip2930(payload) {
  ...
  if (transaction.length !== 8 && transaction.length !== 11) {
    logger2.throwArgumentError("invalid component count for transaction type: 1", "payload", hexlify(payload));
  }
  const tx = {
    type: 1,
    chainId: handleNumber(transaction[0]).toNumber(),
...
function parse(rawTransaction) {
  ...
  return logger2.throwError(`unsupported transaction type: ${payload[0]}`, Logger.errors.UNSUPPORTED_OPERATION, {
...
//# sourceMappingURL=chunk-MKPXTPGQ.js.map
