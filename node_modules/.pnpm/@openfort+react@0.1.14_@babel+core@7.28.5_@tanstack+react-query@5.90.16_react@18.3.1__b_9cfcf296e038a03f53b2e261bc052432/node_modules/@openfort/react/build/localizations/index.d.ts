...
export declare const getLocale: (lang: Languages) => {
    continueWithFamily: string;
    orSelectWallet: string;
    loginWithEmailOrPhone: string;
    connectWithFamilyIOS: string;
    connectWallet: string;
    disconnect: string;
    connected: string;
    wrongNetwork: string;
    switchNetworks: string;
    switchWallets: string;
    chainNetwork: string;
    ...
    buyScreen_heading: string;
    buyScreen_subheading: string;
    buyScreen_payWithCard_title: string;
    buyScreen_payWithCard_description: string;
    buyScreen_payWithCard_url: string;
    buyScreen_exchange_title: string;
    buyScreen_exchange_description: string;
    buyScreen_exchange_url: string;
    buyScreen_wallet_title: string;
    buyScreen_wallet_description: string;
    buyScreen_help: string;
    buyScreen_help_cta: string;
    buyScreen_help_url: string;
